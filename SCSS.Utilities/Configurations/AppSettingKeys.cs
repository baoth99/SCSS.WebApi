...
namespace SCSS.Utilities.Configurations
{
    public class AppSettingKeys
    {
        ...
        public static class AWSSQSSetting
        {
            ...
            public const string CollectingRequestRealtimeQueueUrl = "AWSSQSSetting:CollectingRequestRealtimeQueueUrl";
        ...
        public static class SQLCommand
        {
            ...
            public const string ComplaintCommands = "SqlCommands:ComplaintCommands";
        }
