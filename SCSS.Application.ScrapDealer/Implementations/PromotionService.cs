...
namespace SCSS.Application.ScrapDealer.Implementations
{
    public class PromotionService : BaseService, IPromotionService
    {
        ...
        public PromotionService(IUnitOfWork unitOfWork, IAuthSession userAuthSession, ILoggerService logger, IStringCacheService cacheService) : base(unitOfWork, userAuthSession, logger, cacheService)
        {
